...
// SZNAltmetric
#define COCOAPODS_POD_AVAILABLE_SZNAltmetric
#define COCOAPODS_VERSION_MAJOR_SZNAltmetric 0
#define COCOAPODS_VERSION_MINOR_SZNAltmetric 3
#define COCOAPODS_VERSION_PATCH_SZNAltmetric 0
